...
//  
//  ConnectionDataBase.cs is part of SQLGrenadine 
//  
//  Author:
...
namespace SQLGrenadine.Database.Core
{
	...
	public abstract class ConnectionDataBase
	{
		...
		/// </value>
		public string ConnectionTemplate {get; protected set;}
		...
		/// </param>
		public abstract string GetConnectionString(string password);		
	}
}
